...
export const systems: SystemItem[] = [
  ...
  },
  {
    ...
    description: '외국인 기술 인력 대상 다국어 지원(KO, VN, ID, EN, NP) 맞춤형 인성 평가 및 조직 적합도 검사',
  ...
  },
  {
    ...
    description: '용접, 도장, 전기 직종(비계 제외) 외국인 기술 인력 실무 기량 평가 및 결과 데이터 관리',
    link: 'https://hdhyundai.github.io/korean-skill/', 
    icon: Terminal,
    status: 'ONLINE',
    color: 'amber'
  },
